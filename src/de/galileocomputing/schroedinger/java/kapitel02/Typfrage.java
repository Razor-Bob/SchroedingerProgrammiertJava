...
public class Typfrage {
	public static void main(String[] args) {
		...
		System.out.println(
				zahl + " passt in int Wertebereich: " + (zahl >= Integer.MIN_VALUE && zahl <= Integer.MAX_VALUE));
		System.out.println(
				zahl + " passt in short Wertebereich: " + (zahl >= Short.MIN_VALUE && zahl <= Short.MAX_VALUE));
